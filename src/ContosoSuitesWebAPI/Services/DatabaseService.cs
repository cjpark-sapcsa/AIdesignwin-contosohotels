...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    /// <summary>
    /// Get bookings that are missing associated hotel rooms.
    /// </summary>
    [KernelFunction]
    [Description("Get bookings that are missing associated hotel rooms.")]
    ...
    /// <summary>
    /// Get bookings with more than one associated hotel room.
    /// </summary>
    [KernelFunction]
    [Description("Get bookings with more than one associated hotel room.")]
